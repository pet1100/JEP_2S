...
public class GUILanguage extends JFrame
{
	...
	protected static String datoLang = "Created";
	protected static String cityLang = "City";
	protected static String nameLang = "Name";
	...
	protected static String phoneLang = "Phone Number";
	...
	protected static String caseTypeLang = "Type of case";
}
